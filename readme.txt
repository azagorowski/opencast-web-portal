	...
	--PL--
	Projekt mo¿e zostaæ uruchomiony za pomoc¹ pakietu XAMPP poprzez skopiowanie zawartosci folderu bin do folderu "htdocs" w miejscu instalacji pakietu XAMPP (Przyk³adowo: C:\xampp\htdocs\opencast-web-portal) oraz po w³aczeniu modu³ów Apache oraz MySQL. Nastêpnym krokiem jest wpisanie adresu http://localhost/opencast-web-portal .
